...
public class CommandSwerveDrivetrain extends TunerSwerveDrivetrain implements Subsystem {
  ...
  public Command teleopDrive(
      DoubleSupplier xRate, DoubleSupplier yRate, DoubleSupplier rotationRate) {

    return applyRequest(
        () ->
            teleopDriveRequest
                .withVelocityX(
                    xRate.getAsDouble() * TunerConstants.kSpeedAt12Volts.in(MetersPerSecond))
                .withVelocityY(
                    yRate.getAsDouble() * TunerConstants.kSpeedAt12Volts.in(MetersPerSecond))
                .withRotationalRate(rotationRate.getAsDouble() * Math.PI * 2));
  }
